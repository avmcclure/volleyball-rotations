      ...
      [Arrangement.SERVE]: {
        ...
        players: [
          ...
          },
          {
            ...
            position: Position.OUTSIDE,
            color: Color.GREEN,
            coordinates: { x: 43, y: 24, zone: Zone.III },
          },
          {
            id: 'M1',
            position: Position.MIDDLE,
            color: Color.BLUE,
            coordinates: { x: 50, y: 7, zone: Zone.III },
          },
          {
            id: 'RS',
            position: Position.RIGHT_SIDE,
            color: Color.YELLOW,
            coordinates: { x: 57, y: 16, zone: Zone.III },
          },
          {
            id: 'M2',
            position: Position.MIDDLE,
            color: Color.ORANGE,
            coordinates: { x: 48, y: 44, zone: Zone.V },
          },
          {
            id: 'O2',
            position: Position.OUTSIDE,
        ...
        players: [
          {
            ...
            position: Position.SETTER,
            color: Color.CYAN,
            coordinates: { x: 90, y: 20, zone: Zone.I },
          },
          {
            id: 'O1',
            position: Position.OUTSIDE,
          ...
          },
          {
            ...
            position: Position.RIGHT_SIDE,
            color: Color.GREEN,
            coordinates: { x: 18, y: 71, zone: Zone.IV },
          },
          {
            id: 'O2',
            position: Position.OUTSIDE,
            color: Color.RED,
            coordinates: { x: 48, y: 76, zone: Zone.V },
          },
          {
            id: 'M2',
            position: Position.MIDDLE,
            color: Color.ORANGE,
            coordinates: { x: 83, y: 76, zone: Zone.VI },
          },
        ],
      },
      [Arrangement.BASE]: {
        ...
        players: [
          ...
          },
          {
            ...
            position: Position.RIGHT_SIDE,
            color: Color.YELLOW,
            coordinates: { x: 80, y: 11, zone: Zone.II },
          },
          {
            id: 'M1',
            position: Position.MIDDLE,
            color: Color.BLUE,
            coordinates: { x: 53, y: 11, zone: Zone.III },
          },
          {
            id: 'O1',
            position: Position.OUTSIDE,
            color: Color.GREEN,
            coordinates: { x: 18, y: 12, zone: Zone.IV },
          },
          {
            id: 'O2',
            position: Position.OUTSIDE,
            color: Color.RED,
            coordinates: { x: 53, y: 87, zone: Zone.VI },
          },
          {
            id: 'M2',
            position: Position.MIDDLE,
