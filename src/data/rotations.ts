  ...
  // ROTATION 1 - Setter in Zone I
  {
    ...
    arrangements: {
      [Arrangement.HOME]: {
        ...
        players: [
          createS1({ x: 83, y: 75, zone: Zone.I }),
          createRS1({ x: 83, y: 25, zone: Zone.II }),
      ...
      [Arrangement.SERVE]: {
        ...
        players: [
          ...
          createO1({ x: 43, y: 24, zone: Zone.III }),
          createM1({ x: 50, y: 7, zone: Zone.III }),
          createRS({ x: 57, y: 16, zone: Zone.III }),
          createM2({ x: 48, y: 44, zone: Zone.V }),
          createO2({ x: 38, y: 87, zone: Zone.VI }),
        ],
      },
      [Arrangement.RECEIVE]: {
        ...
        players: [
          createS1({ x: 90, y: 20, zone: Zone.I }),
      ...
      [Arrangement.BASE]: {
        ...
        players: [
          createS1({ x: 85, y: 50, zone: Zone.I }),
          createRS1({ x: 80, y: 11, zone: Zone.II }),
          createM1({ x: 53, y: 11, zone: Zone.III }),
          createO1({ x: 18, y: 12, zone: Zone.IV }),
  ...
  // ROTATION 2 - Setter in Zone VI
  {
    ...
    arrangements: {
      [Arrangement.HOME]: {
        ...
        description: 'Starting positions based on service order',
        players: [
          createRS1({ x: 83, y: 75, zone: Zone.I }),
          ...
          createS1({ x: 50, y: 75, zone: Zone.VI }),
        ],
      },
      [Arrangement.SERVE]: {
        type: Arrangement.SERVE,
        ...
        players: [
          ...
          createS1({ x: 83, y: 65, zone: Zone.VI }),
        ],
      },
      [Arrangement.RECEIVE]: {
        type: Arrangement.RECEIVE,
        ...
        players: [
          createM1({ x: 83, y: 25, zone: Zone.II }),
          createO1({ x: 90, y: 15, zone: Zone.III }),
          createO2({ x: 40, y: 85, zone: Zone.IV }),
          createM2({ x: 60, y: 85, zone: Zone.V }),
          createS1({ x: 75, y: 25, zone: Zone.VI }),
        ],
      },
      [Arrangement.BASE]: {
        type: Arrangement.BASE,
        ...
        players: [
          ...
          createO1({ x: 50, y: 15, zone: Zone.III }),
          createO2({ x: 17, y: 15, zone: Zone.IV }),
          createM2({ x: 15, y: 50, zone: Zone.V }),
          createS1({ x: 85, y: 50, zone: Zone.VI }),
        ],
      },
    },
  },
    ...
    arrangements: {
      [Arrangement.HOME]: {
        ...
        players: [
          ...
          createS1({ x: 17, y: 75, zone: Zone.V }),
        ],
      },
      [Arrangement.SERVE]: {
        type: Arrangement.SERVE,
        ...
        players: [
          createM1({ x: 83, y: 95, zone: Zone.I }),
          createO1({ x: 83, y: 25, zone: Zone.II }),
          createO2({ x: 50, y: 20, zone: Zone.III }),
          createM2({ x: 30, y: 25, zone: Zone.IV }),
          createS1({ x: 50, y: 65, zone: Zone.V }),
        ],
      },
      [Arrangement.RECEIVE]: {
        type: Arrangement.RECEIVE,
        ...
        setupSteps: ['Push setter up', 'Pull passer back', 'Shift back row passers'],
        players: [
          createM1({ x: 17, y: 15, zone: Zone.I }),
          createO1({ x: 90, y: 20, zone: Zone.II }),
          createO2({ x: 40, y: 85, zone: Zone.III }),
          createM2({ x: 70, y: 85, zone: Zone.IV }),
          createS1({ x: 75, y: 25, zone: Zone.V }),
        ],
      },
      [Arrangement.BASE]: {
        type: Arrangement.BASE,
        description: 'Base defensive positions',
        players: [
          createM1({ x: 15, y: 50, zone: Zone.I }),
          createO1({ x: 75, y: 15, zone: Zone.II }),
          createO2({ x: 17, y: 15, zone: Zone.III }),
          createM2({ x: 50, y: 15, zone: Zone.IV }),
          createS1({ x: 85, y: 50, zone: Zone.V }),
        ],
      },
    },
  },
    ...
    arrangements: {
      [Arrangement.HOME]: {
        ...
        players: [
          ...
          createS1({ x: 17, y: 25, zone: Zone.IV }),
          createM1({ x: 50, y: 75, zone: Zone.VI }),
        ],
      },
      [Arrangement.SERVE]: {
        type: Arrangement.SERVE,
        ...
        players: [
          createO1({ x: 50, y: 85, zone: Zone.I }),
          createO2({ x: 75, y: 25, zone: Zone.II }),
          createM2({ x: 50, y: 15, zone: Zone.III }),
          createS1({ x: 60, y: 25, zone: Zone.IV }),
          createM1({ x: 50, y: 70, zone: Zone.VI }),
        ],
      },
      [Arrangement.RECEIVE]: {
        type: Arrangement.RECEIVE,
        ...
        setupSteps: ['Push setter up', 'Pull passer back', 'Shift back row passers'],
        players: [
          createO1({ x: 30, y: 85, zone: Zone.I }),
          createO2({ x: 75, y: 25, zone: Zone.II }),
          createM2({ x: 50, y: 25, zone: Zone.III }),
          createS1({ x: 83, y: 15, zone: Zone.IV }),
          createM1({ x: 50, y: 85, zone: Zone.VI }),
        ],
      },
      [Arrangement.BASE]: {
        type: Arrangement.BASE,
        description: 'Base defensive positions',
        players: [
          createO1({ x: 50, y: 75, zone: Zone.I }),
          createO2({ x: 17, y: 15, zone: Zone.II }),
          createM2({ x: 50, y: 15, zone: Zone.III }),
          createS1({ x: 85, y: 15, zone: Zone.IV }),
          createM1({ x: 15, y: 50, zone: Zone.VI }),
        ],
      },
    },
  },
    ...
    arrangements: {
      [Arrangement.HOME]: {
        ...
        players: [
          ...
          createS1({ x: 50, y: 25, zone: Zone.III }),
          createM1({ x: 17, y: 75, zone: Zone.V }),
          createO1({ x: 50, y: 75, zone: Zone.VI }),
        ],
      },
      [Arrangement.SERVE]: {
        type: Arrangement.SERVE,
        ...
        players: [
          createO2({ x: 17, y: 65, zone: Zone.I }),
          createM2({ x: 75, y: 25, zone: Zone.II }),
          createS1({ x: 60, y: 25, zone: Zone.III }),
          createM1({ x: 17, y: 65, zone: Zone.V }),
          createO1({ x: 17, y: 25, zone: Zone.VI }),
        ],
      },
      [Arrangement.RECEIVE]: {
        type: Arrangement.RECEIVE,
        ...
        setupSteps: ['Push setter up', 'Pull passer back', 'Shift back row passers'],
        players: [
          createO2({ x: 17, y: 25, zone: Zone.I }),
          createM2({ x: 83, y: 25, zone: Zone.II }),
          createS1({ x: 85, y: 15, zone: Zone.III }),
          createM1({ x: 35, y: 85, zone: Zone.V }),
          createO1({ x: 30, y: 85, zone: Zone.VI }),
        ],
      },
      [Arrangement.BASE]: {
        type: Arrangement.BASE,
        description: 'Base defensive positions',
        players: [
          createO2({ x: 17, y: 15, zone: Zone.I }),
          createM2({ x: 50, y: 15, zone: Zone.II }),
          createS1({ x: 85, y: 15, zone: Zone.III }),
          createM1({ x: 15, y: 50, zone: Zone.V }),
          createO1({ x: 50, y: 75, zone: Zone.VI }),
        ],
      },
    },
    ...
    arrangements: {
      [Arrangement.HOME]: {
        ...
        players: [
          ...
          createS1({ x: 83, y: 25, zone: Zone.II }),
          createM1({ x: 17, y: 25, zone: Zone.IV }),
          createO1({ x: 17, y: 75, zone: Zone.V }),
          createO2({ x: 50, y: 75, zone: Zone.VI }),
        ],
      },
      [Arrangement.SERVE]: {
        type: Arrangement.SERVE,
        ...
        players: [
          createM2({ x: 83, y: 95, zone: Zone.I }),
          createS1({ x: 83, y: 15, zone: Zone.II }),
          createM1({ x: 50, y: 15, zone: Zone.IV }),
          createO1({ x: 50, y: 65, zone: Zone.V }),
          createO2({ x: 50, y: 25, zone: Zone.VI }),
        ],
      },
      [Arrangement.RECEIVE]: {
        type: Arrangement.RECEIVE,
        ...
        setupSteps: ['Push setter up', 'Pull passer back', 'Shift back row passers'],
        players: [
          createM2({ x: 70, y: 85, zone: Zone.I }),
          createS1({ x: 90, y: 15, zone: Zone.II }),
          createM1({ x: 17, y: 25, zone: Zone.IV }),
          createO1({ x: 30, y: 85, zone: Zone.V }),
          createO2({ x: 50, y: 85, zone: Zone.VI }),
        ],
      },
      [Arrangement.BASE]: {
        type: Arrangement.BASE,
        description: 'Base defensive positions',
        players: [
          createM2({ x: 15, y: 50, zone: Zone.I }),
          createS1({ x: 85, y: 15, zone: Zone.II }),
          createM1({ x: 50, y: 15, zone: Zone.IV }),
          createO1({ x: 50, y: 75, zone: Zone.V }),
          createO2({ x: 17, y: 15, zone: Zone.VI }),
        ],
      },
    },
  },
