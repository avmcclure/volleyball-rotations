  ...
  // ROTATION 1 - Setter in Zone I
  {
    ...
    arrangements: {
      ...
      [Arrangement.SERVE]: {
        ...
        players: [
          createS({ x: 82, y: 92, zone: Zone.I }),
          createO1({ x: 57, y: 17, zone: Zone.III }),
          createM1({ x: 50, y: 9, zone: Zone.III }),
          createRS({ x: 43, y: 22, zone: Zone.III }),
          createM2({ x: 39, y: 44, zone: Zone.III }),
          createO2({ x: 32, y: 88, zone: Zone.V })
        ],
      },
      [Arrangement.RECEIVE]: {
