        ...
        <div className="flex-1">
          {allCorrect ? (
            <div>
              ...
              <p className="text-sm text-green-800">You got all {totalCount} positions correct!</p>
            </div>
          ) : (
            <div>
              <h3 className="font-semibold text-yellow-900">Almost there!</h3>
              <p className="text-sm text-yellow-800">
                You got {correctCount} out of {totalCount} correct. Try adjusting the highlighted
                positions.
              </p>
            </div>
          )}
